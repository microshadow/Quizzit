  ...
  _createClass(Banner, [{
    ...
    value: function getLoginButton() {
      ...
      return _react.default.createElement('a', {
        ...
        id: 'logButton',
        className: 'linkButton qButton textshadow'
      }, buttonText));
    }
  }, {
    key: 'getStatsLink',
    ...
    value: function render() {
      ...
      }, this.makeLogo(), _react.default.createElement('div', {
        className: 'links d-flex justify-content-end'
      }, _react.default.createElement('div', {
        id: 'homeButton',
        className: 'linkButton qButton textshadow'
      }, 'Home'), this.getStatsLink(), this.getLoginButton())), (0, _globals.createHorizontalDivider)(6, "detail-dark"));
    }
  }]);
...
},{"./globals.js":3,"react":16}],3:[function(require,module,exports){
"use strict";
...
var _mainTemplate = _interopRequireDefault(require("./mainTemplate.js"));
...
var rootElem = _react.default.createElement(_mainTemplate.default, {
  userType: _globals.STUDENT
}, _react.default.createElement(_progressBar.default, {
  percent: 97.57
}, 'Class Average'));

_reactDom.default.render(rootElem, document.getElementById('root'));

},{"./globals.js":3,"./mainTemplate.js":5,"./progressBar.js":6,"react":16,"react-dom":13}],5:[function(require,module,exports){
"use strict";
  ...
  _createClass(Template, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement('div', {
        ...
        id: 'pageContentRow',
        className: 'd-flex align-items-stretch flex-grow-1'
...
},{"./banner.js":2,"./globals.js":3,"./sidebar.js":7,"react":16}],6:[function(require,module,exports){
"use strict";
...
var ProgressBar = function (_Component) {
  ...
  _createClass(ProgressBar, [{
    ...
    value: function render() {
      ...
      var fillBarChildren = [_react.default.createElement("div", {
        className: "progressBarText textOverlay"
      }, this.props.children)];
      var lastChildren = [];

      if (percentFull >= 70) {
        fillBarChildren.push(_react.default.createElement("div", {
          className: "progressBarPercent textOverlay"
        }, barWidth));
      } else {
        lastChildren.push(_react.default.createElement("div", {
      ...
      return _react.default.createElement("div", {
        ...
        style: fillStyle
      }, fillBarChildren), _react.default.createElement("div", {
        className: "progressBarText",
        style: textStyle
      }, this.props.children), lastChildren);
    }
  }]);
...
var Sidebar = function (_Component) {
  ...
  _createClass(Sidebar, [{
    ...
    value: function getCourseDropdownLinks(course) {
      if (this.props.userType === _globals.STUDENT) {
        var links = [{
          "text": "View History",
          "href": "#"
        }];
        ...
        return links;
      } else if (this.props.userType === _globals.EDUCATOR) {
        var firstOp = {};
      ...
      } else if (this.props.userType === _globals.ADMIN) {
        return [{
          "text": "Edit Staff",
          "href": "#"
        }, {
    ...
    value: function constructCourseMenu(course, parentID) {
      ...
      return _react.default.createElement('div', {
        ...
        'class': 'qButton courseLabel textshadow',
        type: 'button',
        'data-toggle': 'collapse',
        'data-target': targetSelector,
        'aria-expanded': 'true',
        'aria-controls': targetID
      }, course.name), _react.default.createElement('div', {
        id: targetID,
        'class': 'courseMenu collapse',
        'aria-labelledby': controllerID,
        'data-parent': parentSelector
      }, _react.default.createElement('ul', null, linkComponents)));
    }
  }, {
    ...
    value: function render() {
      ...
      }, (0, _globals.createVerticalDivider)(8, "detail-dark"), _react.default.createElement('div', {
        id: 'sidebar'
      }, _react.default.createElement('div', {
        id: 'coursesMenu'
      }, _react.default.createElement('div', {
      ...
      }, 'Courses'), _react.default.createElement('div', {
...
},{"./globals.js":3,"react":16}],8:[function(require,module,exports){
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
},{"_process":1,"object-assign":8,"prop-types/checkPropTypes":9,"react":16,"scheduler":21,"scheduler/tracing":22}],12:[function(require,module,exports){
/** @license React v16.6.0
...
},{"_process":1,"object-assign":8,"prop-types/checkPropTypes":9}],15:[function(require,module,exports){
/** @license React v16.6.0
...
},{"./cjs/react.development.js":14,"./cjs/react.production.min.js":15,"_process":1}],17:[function(require,module,exports){
(function (process){
/** @license React v16.6.0
...
},{"./cjs/scheduler.development.js":19,"./cjs/scheduler.production.min.js":20,"_process":1}],22:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./cjs/scheduler-tracing.development.js":17,"./cjs/scheduler-tracing.production.min.js":18,"_process":1}]},{},[4]);
